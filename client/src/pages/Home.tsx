...
import { Heart, Stars, Gift, Calendar, MessageCircle, Music, Zap } from "lucide-react";
...
const LoveNoteForm = () => {
  ...
  return (
    <form onSubmit={form.handleSubmit((data) => mutate({ type: 'message', content: data }))} className="space-y-4">
      <Textarea 
        placeholder="Write something sweet..." 
        className="min-h-[120px] rounded-xl border-pink-100 focus:border-pink-300 focus:ring-pink-100 bg-pink-50/30"
        {...form.register("message")}
      />
      <Button disabled={isPending} type="submit" className="w-full rounded-xl bg-pink-400 hover:bg-pink-500 text-white">
...
const DateIdeaForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Button disabled={isPending} type="submit" className="w-full rounded-xl bg-rose-400 hover:bg-rose-500 text-white">
        Submit Idea 💡
      </Button>
    </form>
  );
  ...
  return (
    <div className="space-y-4 text-center">
      <div className="flex gap-2 items-center">
        <Input placeholder="You" className="rounded-xl text-center border-pink-100" />
        <Heart className="text-pink-400 animate-pulse fill-pink-200" />
        <Input placeholder="Crush" className="rounded-xl text-center border-pink-100" />
      </div>
      ...
      {score !== null && (
        ...
        >
          <div className="text-4xl font-display text-pink-600 mb-1">{score}%</div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-pink-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="font-display text-xl text-pink-400">Loading our love story...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FFF0F5] selection:bg-pink-200">
      ...
      <header className="py-12 md:py-20 text-center relative overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl mb-4 font-display text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-rose-500 to-purple-500 drop-shadow-sm pb-2">
            Our Love Story
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <main className="w-full lg:w-[60%] space-y-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-display text-gray-700">Memory Lane</h2>
            </div>
            ...
            {posts && posts.length > 0 ? (
              ...
              <Card className="border-dashed border-2 border-pink-200 bg-transparent shadow-none">
                <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-gray-400 font-display text-xl">No memories yet...</p>
                  <p className="text-gray-400 text-sm">But our future is bright! ✨</p>
                </CardContent>
              </Card>
            )}
            ...
            <div className="text-center pt-8 pb-12">
              ...
              <p className="mt-4 text-gray-400 font-display text-lg">To be continued...</p>
            </div>
          </main>
            ...
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-xl shadow-pink-100/60 border border-pink-100 relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display text-gray-700">Fun Zone</h2>
                </div>

                <Accordion type="single" collapsible className="w-full" defaultValue="note">
                  ...
                  <AccordionItem value="note" className="border-pink-100">
                    <AccordionTrigger className="font-display text-lg hover:text-pink-500 hover:no-underline px-2">
                      <span className="flex items-center gap-2">💌 Send a Love Note</span>
                    </AccordionTrigger>
                  ...
                  <AccordionItem value="date" className="border-pink-100">
                    <AccordionTrigger className="font-display text-lg hover:text-pink-500 hover:no-underline px-2">
                      <span className="flex items-center gap-2">🌹 Date Ideas</span>
                    </AccordionTrigger>
                    <AccordionContent className="p-2 pt-4">
                      <DateIdeaForm />
                    </AccordionContent>
                  ...
                  <AccordionItem value="calc" className="border-pink-100">
                    <AccordionTrigger className="font-display text-lg hover:text-pink-500 hover:no-underline px-2">
                      <span className="flex items-center gap-2">🔢 Love Calculator</span>
                    </AccordionTrigger>
                    <AccordionContent className="p-2 pt-4">
                      <LoveCalculator />
                    </AccordionContent>
                  ...
                  <AccordionItem value="mood" className="border-pink-100">
                    <AccordionTrigger className="font-display text-lg hover:text-pink-500 hover:no-underline px-2">
                      <span className="flex items-center gap-2">🌈 Mood Check</span>
                    </AccordionTrigger>
                    <AccordionContent className="p-2 pt-4">
                      <MoodCheckForm />
                    </AccordionContent>
